"""Regression checks for the ion-trace-metric-probe casebook."""
...
from casebook.harness import assert_expected, ion_trace_metric_probe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(ion_trace_metric_probe_summary(), assert_expected())
